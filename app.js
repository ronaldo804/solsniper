...
// Real trending tokens as fallback (Using real IPFS/CDN links)
...
function renderRealCoins(coins) {
    ...
    coins.forEach(coin => {
        ...
        const imgUrl = coin.image_uri || `https://api.dicebear.com/7.x/identicon/svg?seed=${coin.symbol}`;

        card.innerHTML = `
            <img src="${imgUrl}" class="coin-img" alt="${coin.name}" onerror="this.src='https://api.dicebear.com/7.x/identicon/svg?seed=${coin.symbol}'">
            <div class="coin-info">
                <h3>${coin.name} [${coin.symbol}]</h3>
                <p class="desc">${coin.description || "No description available."}</p>
                <div class="stats">
                    <div class="stat">
                ...
                <div class="progress-container">
                    ...
                    <span class="progress-text">bonding curve: ${Math.floor(progress)}%</span>
                </div>
            </div>
        `;
